...
def input_dataset(dataset, noise_type, noise_path, is_human):
    if dataset == 'cifar10':
        ...
        eval_train_dataset = CIFAR10(root='~/data/',
                                download=False,  
                                train=False, 
                                transform = test_cifar10_transform,
                                noise_type=noise_type
        ...
        eval_train_dataset = CIFAR100(root='~/data/',
                                download=False,  
                                train=False, 
                                transform = test_cifar10_transform,
                                noise_type=noise_type
        ...
        num_classes = 100
        num_training_samples = 50000
    return train_dataset, test_dataset, eval_train_dataset, num_classes, num_training_samples
