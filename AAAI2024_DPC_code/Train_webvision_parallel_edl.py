...
parser.add_argument('--gpuid1', default=2, type=int)
parser.add_argument('--gpuid2', default=3, type=int)
...
def eval_train(eval_loader,model,device,whichnet,queue):   
    ...
    with open("margins.pkl","wb") as f:
        pickle.dump(margins,f)
...
if __name__ == "__main__":
    ...
    loader = dataloader.webvision_dataloader(batch_size=args.batch_size,num_class = args.num_class,num_workers=4,root_dir=args.data_path,log=stats_log)
